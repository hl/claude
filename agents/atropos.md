...
description: >-
  ...
  agent-agnostic: currently driven by codex/GPT via the `atropos` codex profile
  (~/.codex/atropos.config.toml; fallback: the ~/.codex/AGENTS.md shim on prompts
  opening "Atropos:"), but any reviewing model can load this file.
---
